    ...
    <div class="hero-grid">
      ...
      <div class="hero-visual">
        <div class="hero-card-stack">
          <div style="border-radius:var(--radius-md); overflow:hidden; border:1px solid rgba(255,255,255,0.15); box-shadow:var(--shadow-xl);">
            <img src="images/hero_composite.jpg" alt="Mirai Packaging Corrugated Box and Courier Mailer Range" class="hero-banner-img"/>
          </div>
