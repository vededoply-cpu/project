  ...
  <div class="container">
    <div class="hero-grid">
      <div class="hero-content">
        ...
        <p class="hero-desc">
          Mirai Packaging LLP is Bangalore's premier manufacturing and wholesale enterprise. We solve multi-vendor procurement bottlenecks by delivering tailor-made 2 to 9 Ply corrugated cartons, tamper-proof courier mailers, high-shear BOPP tapes, and transit security seals on a single enterprise platform.
        </p>
        ...
        <div class="hero-stats">
          ...
          <div>
            <div class="hero-stat-num">
              <span>9<span class="plus">Ply</span></span>
            </div>
            <div class="hero-stat-lbl">Max Corrugation Ply</div>
          </div>
        </div>
      </div>
        ...
        <div class="hero-img-card" id="heroSliderCard">
          <div class="hero-slider-track" id="heroSliderTrack">
            ...
            <div class="hero-slide active">
              <img src="images/hero_composite.jpg" alt="Corrugated Boxes &amp; Packaging Range"/>
              <div class="hero-slide-badge">Corrugated Cartons &amp; Mailers</div>
            </div>

            <div class="hero-slide">
              <img src="images/corrugated_box.jpg" alt="Heavy Duty Corrugated Box"/>
              <div class="hero-slide-badge">Heavy-Duty RSC Master Boxes</div>
            </div>

            <div class="hero-slide">
              <img src="images/corrugated_lineup.jpg" alt="Corrugated Box Manufacturing"/>
              <div class="hero-slide-badge">Automated 3-Ply &amp; 5-Ply Lineup</div>
            </div>

            <div class="hero-slide">
              <img src="images/courier_bag.jpg" alt="Tamper Proof Courier Mailers"/>
              <div class="hero-slide-badge">Co-Ex Tamper-Proof Mailer Flyers</div>
            </div>

            <div class="hero-slide">
              <img src="images/tape_rolls.jpg" alt="BOPP Packaging Tapes"/>
            ...
            <div class="hero-slide">
              ...
              <div class="hero-slide-badge">ISPM-15 Heat-Treated Export Pallets</div>
            </div>

            <div class="hero-slide">
              <img src="images/pp_box.jpg" alt="PP Flute Reusable Boxes"/>
              <div class="hero-slide-badge">PP Corrugated Flute Boxes</div>
            </div>

            <div class="hero-slide">
              <img src="images/stretch_film.jpg" alt="LLDPE Stretch Wrap Film"/>
              <div class="hero-slide-badge">Cast LLDPE Stretch Film Rolls</div>
            </div>

            <div class="hero-slide">
              <img src="images/bubble_wrap.jpg" alt="Air Bubble Protective Rolls"/>
              <div class="hero-slide-badge">Air Bubble Protective Rolls</div>
            </div>

            <div class="hero-slide">
              <img src="images/quality_testing.jpg" alt="In-House Testing Laboratory"/>
              <div class="hero-slide-badge">In-House BCT &amp; QC Testing Lab</div>
            </div>

            <div class="hero-slide">
              <img src="images/modern_machinery.jpg" alt="High Speed Corrugation Machinery"/>
              <div class="hero-slide-badge">High-Speed Corrugation Machinery</div>
            </div>

            <div class="hero-slide">
              <img src="images/security_seal.jpg" alt="Logistics Security Seals"/>
              <div class="hero-slide-badge">Pull-Tight Security Seals</div>
            </div>
    ...
    <div class="products-grid">
      ...
      <div class="product-card" data-category="boxes">
        <div class="product-thumb">
          <img src="images/corrugated_lineup.jpg" alt="Corrugated Packaging Shipping Boxes Lineup"/>
      ...
      <div class="product-card" data-category="boxes">
        <div class="product-thumb">
          <img src="images/courier_bag.jpg" alt="Tamper-Proof Poly Courier Mailer Bags"/>
      ...
      <div class="product-card" data-category="boxes">
        <div class="product-thumb">
          <img src="images/kraft_paper_bags.jpg" alt="Eco Friendly Kraft Paper Bags and Honeycomb Cushioning Roll"/>
      ...
      <div class="product-card" data-category="industrial">
        <div class="product-thumb">
          <img src="images/epoxy_flooring.jpg" alt="Industrial Epoxy Flooring with Safety Line Marking"/>
          <span class="product-thumb-tag">Factory Flooring</span>
          <span class="product-badge-accent">Anti-Dusting</span>
        </div>
        <div class="product-body">
          <h3 class="product-title">Industrial Epoxy Flooring &amp; Line Marking</h3>
          <p class="product-desc">
            High-impact self-leveling resinous epoxy floor coating systems for industrial plants, logistics warehouses, clean rooms, and high-visibility safety line markings.
          </p>
          <div class="product-specs">
            <span class="spec-pill">Thickness: <strong>1.5 – 4.0 mm</strong></span>
            <span class="spec-pill">Strength: <strong>&gt; 65 N/mm²</strong></span>
            <span class="spec-pill">Resist: <strong>Chemical &amp; Oil</strong></span>
      ...
      <div class="product-card" data-category="tapes">
        <div class="product-thumb">
          ...
          <span class="product-badge-accent">2-Layer &amp; 3-Layer</span>
        </div>
        <div class="product-body">
          <h3 class="product-title">Air Bubble Wrap &amp; Cushioning Rolls</h3>
          <p class="product-desc">
            High-density poly air bubble wrap rolls (10mm &amp; 20mm bubble size) and anti-static ESD pink bubble rolls engineered for fragile electronics and glass transit safety.
          </p>
          <div class="product-specs">
            <span class="spec-pill">Bubble Size: <strong>10mm &amp; 20mm</strong></span>
            <span class="spec-pill">Grammage: <strong>40 – 120 GSM</strong></span>
            <span class="spec-pill">Roll Width: <strong>0.5m – 1.5m</strong></span>
            <span class="spec-pill">Type: <strong>Standard &amp; Anti-Static</strong></span>
          </div>
          <div class="product-footer">
      ...
      <!-- 11. PP Strapping Rolls & Heavy-Duty PET Straps -->
      <div class="product-card" data-category="tapes">
        <div class="product-thumb">
          <img src="images/hero_composite.jpg" alt="PP Strapping Rolls and PET Green Embossed Straps"/>
          <span class="product-thumb-tag">Bundle Binding</span>
          <span class="product-badge-accent">High Tensile</span>
        </div>
        <div class="product-body">
          <h3 class="product-title">PP Strapping Rolls &amp; PET Heavy Straps</h3>
          <p class="product-desc">
            Heat-sealable PP straps for fully automatic strapping machines and high-tensile green embossed PET polyester straps for heavy pallet unitization and box binding.
          </p>
          <div class="product-specs">
            <span class="spec-pill">Width: <strong>9mm, 12mm, 15mm, 19mm</strong></span>
            <span class="spec-pill">Break Load: <strong>120 – 550 kgf</strong></span>
            <span class="spec-pill">Grade: <strong>Manual &amp; Automatic</strong></span>
            <span class="spec-pill">Surface: <strong>Embossed &amp; Plain</strong></span>
          </div>
          <div class="product-footer">
            <a href="products.php#strapping" class="product-cta-link">
              View Technical Specs
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </a>
            <a href="contact.php?prod=strapping" class="product-inquiry-btn">Enquire Bulk</a>
          </div>
        </div>
      </div>
