        ...
        <div class="hero-img-card" id="heroSliderCard">
          <div class="hero-slider-track" id="heroSliderTrack">
            ...
            <div class="hero-slide">
              <img src="images/product_photo_5.jpg" alt="PP Flute Corrugated Box"/>
              <div class="hero-slide-badge">PP Corrugated Flute Box</div>
            ...
            <div class="hero-slide">
              ...
              <div class="hero-slide-desc">Complete range of stretch films, bubble wrap, poly mailers &amp; strapping solutions.</div>
            </div>
            ...
            <div class="hero-slide">
              ...
              <div class="hero-slide-desc">High-capacity warehouse pallet racking systems designed for heavy pallet storage.</div>
            </div>
            ...
            <div class="hero-slide">
              ...
              <div class="hero-slide-desc">Custom modular racking aisles engineered for maximum vertical storage density.</div>
            </div>
            ...
            <div class="hero-slide">
              ...
              <div class="hero-slide-desc">Multi-layer air bubble rolls &amp; EPE foam sheets for fragile item protection.</div>
            </div>
            ...
            <div class="hero-slide">
              ...
              <div class="hero-slide-desc">3-Ply, 5-Ply &amp; 7-Ply corrugated boxes custom engineered for high bursting strength.</div>
            </div>

            <div class="hero-slide">
              <img src="images/courier_bag.jpg" alt="Tamper Proof Courier Mailers"/>
              <div class="hero-slide-badge">Co-Ex Poly Courier Mailers</div>
              <div class="hero-slide-desc">Tamper-evident polyethylene mailers with permanent seal strip for e-commerce.</div>
            </div>
            ...
            <div class="hero-slide">
              ...
              <div class="hero-slide-desc">Customized fluted PP totes with ultrasonic spot welding &amp; corner edge locks.</div>
            </div>

            <div class="hero-slide">
              <img src="images/tape_rolls.jpg" alt="BOPP Packaging Tapes"/>
              <div class="hero-slide-badge">Industrial Packaging Tapes</div>
              <div class="hero-slide-desc">High-strength carton sealing tapes for secure automated box taping.</div>
            </div>
    ...
    <div class="products-grid">
      ...
      <div class="product-card" data-category="industrial">
        <div class="product-thumb">
          ...
          <span class="product-thumb-tag">Warehouse Infrastructure</span>
          <span class="product-badge-accent">Racks &amp; Crates Complement</span>
        </div>
        <div class="product-body">
