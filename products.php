  ...
  <div class="container">
      ...
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/corrugated_lineup.jpg" alt="Corrugated Box Sizes Lineup" style="width:100%; height:290px; object-fit:contain; background:#ffffff;"/>
          </div>
          <div style="border-radius:var(--radius-xs); overflow:hidden; border:1px solid var(--border-subtle);">
            <img src="images/corrugated_box.jpg" alt="RSC Corrugated Box" style="height:120px; width:100%; object-fit:contain; background:#ffffff;"/>
          </div>
        </div>
    ...
    <div class="product-filter-card" data-category="racks" id="racks" style="margin-bottom:60px;">
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/heavy_duty_rack.jpg" alt="Heavy Duty Industrial Pallet Rack" style="width:100%; height:290px; object-fit:contain; background:#ffffff;"/>
          </div>
          <div style="border-radius:var(--radius-xs); overflow:hidden; border:1px solid var(--border-subtle);">
            <img src="images/heavy_duty_rack_row.jpg" alt="Warehouse Selective Pallet Racking System" style="height:120px; width:100%; object-fit:contain; background:#ffffff;"/>
          </div>
        </div>
      ...
      <div class="product-detail-card">
        <div>
          ...
          <div class="grid-2col-thumbs">
            ...
            <img src="images/plastic_crate.jpg" alt="Stackable HDPE Plastic Crates with Lids" style="border-radius:var(--radius-xs); height:120px; width:100%; object-fit:contain; background:#ffffff; border:1px solid var(--border-subtle);"/>
          </div>
    ...
    <div class="product-filter-card" data-category="flooring" id="flooring" style="margin-bottom:30px;">
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/epoxy_flooring.jpg" alt="Industrial Epoxy Flooring with Safety Line Marking" style="width:100%; height:290px; object-fit:contain; background:#ffffff;"/>
          </div>
          <div style="border-radius:var(--radius-xs); overflow:hidden; border:1px solid var(--border-subtle);">
            <img src="images/epoxy_flooring_warehouse.jpg" alt="High Gloss Seamless Epoxy Warehouse Floor" style="height:120px; width:100%; object-fit:contain; background:#ffffff;"/>
          </div>
        </div>
