...
<div style="background:var(--bg-neutral); padding:16px 0; border-bottom:1px solid var(--border-subtle); position:sticky; top:80px; z-index:90;">
  <div class="container">
    <div style="display:flex; gap:8px; flex-wrap:wrap; align-items:center;">
      ...
      <button class="btn btn-sm btn-outline product-filter-btn" data-filter="boxes">Corrugated Boxes</button>
      <button class="btn btn-sm btn-outline product-filter-btn" data-filter="courier">Courier Bags</button>
      <button class="btn btn-sm btn-outline product-filter-btn" data-filter="tapes">BOPP Tapes</button>
      <button class="btn btn-sm btn-outline product-filter-btn" data-filter="eco">Eco &amp; Cushioning</button>
      <button class="btn btn-sm btn-outline product-filter-btn" data-filter="stretch">Stretch &amp; Strapping</button>
      <button class="btn btn-sm btn-outline product-filter-btn" data-filter="racks">Storage Racks</button>
      <button class="btn btn-sm btn-outline product-filter-btn" data-filter="pallets">Pallets &amp; Equipment</button>
      <button class="btn btn-sm btn-outline product-filter-btn" data-filter="flooring">Epoxy Flooring</button>
    </div>
  </div>
</div>
  ...
  <div class="container">
      ...
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/corrugated_lineup.jpg" alt="Corrugated Box Sizes Lineup" style="width:100%; height:290px; object-fit:cover;"/>
          </div>
          <div style="border-radius:var(--radius-xs); overflow:hidden; border:1px solid var(--border-subtle);">
            <img src="images/corrugated_box.jpg" alt="RSC Corrugated Box" style="height:120px; width:100%; object-fit:cover;"/>
          </div>
        </div>
    ...
    <div class="product-filter-card" data-category="courier" id="courier" style="margin-bottom:60px;">
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/courier_bag.jpg" alt="Tamper Proof Poly Courier Bags" style="width:100%; height:290px; object-fit:cover;"/>
          </div>
          <div style="border-radius:var(--radius-xs); overflow:hidden; border:1px solid var(--border-subtle);">
            <img src="images/hero_composite.jpg" alt="Packaging Bags and Flyers" style="height:120px; width:100%; object-fit:cover;"/>
          </div>
        </div>
      ...
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; border:1px solid var(--border-subtle);">
            <img src="images/tape_rolls.jpg" alt="Industrial BOPP Adhesive Tapes" style="width:100%; height:290px; object-fit:cover;"/>
          </div>
        </div>
    ...
    <div class="product-filter-card" data-category="eco" id="ecopack" style="margin-bottom:60px;">
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/kraft_paper_bags.jpg" alt="Eco Friendly Kraft Paper Bags and Honeycomb Paper" style="width:100%; height:290px; object-fit:cover;"/>
          </div>
          <div style="border-radius:var(--radius-xs); overflow:hidden; border:1px solid var(--border-subtle);">
            <img src="images/bubble_wrap.jpg" alt="Air Bubble Protective Wrap Roll" style="height:120px; width:100%; object-fit:cover;"/>
          </div>
        </div>
    ...
    <div class="product-filter-card" data-category="stretch" id="stretch" style="margin-bottom:60px;">
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/stretch_film.jpg" alt="Industrial Stretch Wrap Rolls" style="width:100%; height:290px; object-fit:cover;"/>
          </div>
          <div style="border-radius:var(--radius-xs); overflow:hidden; border:1px solid var(--border-subtle);">
            <img src="images/security_seal.jpg" alt="Tamper Evident Security Seals" style="height:120px; width:100%; object-fit:cover;"/>
          </div>
        </div>
    ...
    <div class="product-filter-card" data-category="racks" id="racks" style="margin-bottom:60px;">
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/heavy_duty_rack.jpg" alt="Heavy Duty Industrial Pallet Rack" style="width:100%; height:290px; object-fit:cover;"/>
          </div>
          <div style="border-radius:var(--radius-xs); overflow:hidden; border:1px solid var(--border-subtle);">
            <img src="images/heavy_duty_rack_row.jpg" alt="Warehouse Selective Pallet Racking System" style="height:120px; width:100%; object-fit:cover;"/>
          </div>
        </div>
    ...
    <!-- 7. INDUSTRIAL PALLETS, CRATES & PP BOXES -->
    <div class="product-filter-card" data-category="pallets" id="pallets" style="margin-bottom:60px;">
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/plastic_pallets.jpg" alt="Heavy Duty Plastic Pallets Stack" style="width:100%; height:290px; object-fit:cover;"/>
          </div>
          <div class="grid-2col-thumbs">
            <img src="images/wooden_pallets.jpg" alt="ISPM-15 Heat Treated Wooden Pallet" style="border-radius:var(--radius-xs); height:120px; width:100%; object-fit:cover; border:1px solid var(--border-subtle);"/>
            <img src="images/plastic_crate.jpg" alt="Stackable HDPE Plastic Crates with Lids" style="border-radius:var(--radius-xs); height:120px; width:100%; object-fit:cover; border:1px solid var(--border-subtle);"/>
          </div>
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px; margin-top:10px;">
            <img src="images/pp_box.jpg" alt="PP Flute Corrugated Reusable Boxes" style="border-radius:var(--radius-xs); height:120px; width:100%; object-fit:cover; border:1px solid var(--border-subtle);"/>
            <img src="images/pallet_truck.jpg" alt="Hydraulic Pallet Jack Truck" style="border-radius:var(--radius-xs); height:120px; width:100%; object-fit:cover; border:1px solid var(--border-subtle);"/>
          </div>
        </div>
    ...
    <div class="product-filter-card" data-category="flooring" id="flooring" style="margin-bottom:30px;">
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/epoxy_flooring.jpg" alt="Industrial Epoxy Flooring with Safety Line Marking" style="width:100%; height:290px; object-fit:cover;"/>
          </div>
          <div style="border-radius:var(--radius-xs); overflow:hidden; border:1px solid var(--border-subtle);">
            <img src="images/epoxy_flooring_warehouse.jpg" alt="High Gloss Seamless Epoxy Warehouse Floor" style="height:120px; width:100%; object-fit:cover;"/>
          </div>
        </div>
        ...
        <div>
          ...
          <div style="background:var(--bg-subtle, #f8fafc); border:1px solid var(--border-subtle, #e2e8f0); border-radius:var(--radius-sm); padding:18px; margin:20px 0;">
            <h4 style="font-family:var(--font-heading); font-weight:700; font-size:1.05rem; color:var(--text-primary); margin-bottom:10px; display:flex; align-items:center; gap:8px;">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;color:var(--blue-brand);"><path d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5m0 0h9m-9 0V9a2 2 0 012-2h2a2 2 0 012 2v12m-6 0h6"/></svg>
    ...
    <div class="product-filter-card" data-category="eco" id="bubble" style="margin-bottom:60px;">
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/bubble_wrap.jpg" alt="Air Bubble Wrap Packaging Rolls" style="width:100%; height:290px; object-fit:cover;"/>
          </div>
        </div>
    ...
    <div class="product-filter-card" data-category="stretch" id="strapping" style="margin-bottom:60px;">
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/hero_composite.jpg" alt="PP Strapping Rolls and PET Green Straps" style="width:100%; height:290px; object-fit:cover;"/>
          </div>
        </div>
    ...
    <div class="product-filter-card" data-category="pallets" id="pallettruck" style="margin-bottom:60px;">
      <div class="product-detail-card">
        <div>
          <div style="border-radius:var(--radius-sm); overflow:hidden; margin-bottom:16px; border:1px solid var(--border-subtle);">
            <img src="images/pallet_truck.jpg" alt="Industrial Hydraulic Hand Pallet Truck" style="width:100%; height:290px; object-fit:cover;"/>
          </div>
        </div>
