...
<section style="background:linear-gradient(135deg, #071e3d 0%, #0f2b57 100%); color:#ffffff; padding:44px 0; border-top:3px solid var(--orange-brand); border-bottom:1px solid #1e293b;" id="catalogue-qr">
  <div class="container">
    <div style="display:grid; grid-template-columns:1.4fr 1fr; gap:32px; align-items:center;" class="product-card-grid">
      ...
      <div>
        ...
        <div style="display:flex; gap:12px; align-items:center; flex-wrap:wrap; margin-bottom:14px;">
          ...
          <a href="pdf/Mirai_Packaging_Master_Catalogue.pdf" target="_blank" rel="noopener" class="btn btn-outline" style="color:#ffffff; border-color:rgba(255,255,255,0.3); padding:12px 18px; font-size:0.9rem;">
            View Online PDF
          </a>
        </div>
